...
def printfun(numthreads, blocklist,itercount):
  for s in blocklist:
      for mode in ["forward","gradient"]:
        os.system("OMP_NUM_THREADS={}  taskset -c 0-{} numactl -i all ~/enzyme-sc22/LULESH-CPP/ompOpt-single-{}.exe -s {} -i {} > omp-single_{}_{}_{}_{}.txt".format(numthreads, numthreads-1, mode, s, itercount, mode,numthreads, itercount, s))
